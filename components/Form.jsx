    ...
    return (
        ...
        <div className="space-y-3">
            <div className="relative border-b border-gray-900/10 pb-12 flex md:flex-row flex-col p-8 justify-between gap-8 md:gap-4">
                        ...
                        <div className="mt-2">
                            <div className="flex h-[10vw] md:h-[17vw] xl:h-[23vw] pb-[10%] md:pb-[50%] xl:pb-[70%] rounded-md shadow-sm ring-1 ring-inset ring-gray-300  sm:max-w-full ">    
                                <input
                                    ...
                                    id="title"
                                    className="break-all w-full align-top h-[10vw] md:h-[17vw] xl:h-[23vw] pb-[10%] md:pb-[50%] xl:pb-[70%] block flex-1 border-0 bg-transparent pl-1 text-gray-900  placeholder:text-gray-400 sm:text-sm sm:leading-6 "
                ...
                <div className='md:w-full h-[80%] mt-0 sm:mt-3 sm:mr-3 mr-0 space-y-5'>
                    <div className=" md:min-w-[390px] min-w-[30vw] bg-white rounded-xl shadow-md p-7" onDragOver={handleDragOver} onDrop={handleDrop}>
