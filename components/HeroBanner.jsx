'use client'
import banner1 from '../assets/arto1.jpg'
import banner2 from '../assets/arto2.jpg'
import banner3 from '../assets/arto3.jpg'
            ...
            <div className="mx-auto max-w-7xl px-6 pb-32 pt-36 sm:pt-60 lg:px-8 lg:pt-32">
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="relative w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                  <h1 className="sm:ml-4 ml-0 text-6xl flex flex-wrap max-w-[89vw] font-bold tracking-tight text-gray-900 sm:text-5xl">
                  Explore and Sell Art Creations
                  </h1>
                  <p className="mt-6 sm:ml-4 ml-0 text-lg flex flex-wrap max-w-[89vw] leading-8 text-gray-600 sm:max-w-md lg:max-w-none">
                  ...
                  <div className='ml-4 bg-white border-slate-300 border-[1px] shadow-lg p-4 rounded-xl mt-6 w-[66%]'>
                    ...
                    <label className="inline-flex items-center cursor-pointer mt-4" >
                        ...
                        <div className="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-pink-400 dark:peer-focus:ring-pink-300 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-pink-300"></div>
                        <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">Toggle me to signin/singout</span>
                    </label>
                  </div>
