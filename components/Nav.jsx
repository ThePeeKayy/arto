...
const Nav = () => {
    ...
    return (
        <>
        {showCart && <Cart />}
        <nav className='flex justify-between sm:justify-evenly h-auto pb-2 w-full relative' >
            ...
            <div className='w-[30%] mr-0 lg:mr-[79px]'>
                ...
                <div className='flex gap-1 md:gap-2 mt-3 mr-8 pr-4 lg:hidden justify-end '>
                    ...
                    <div className='mt-3 mr-8 pr-4 flex flex-row gap-2'>
