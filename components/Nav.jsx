...
const Nav = () => {
    ...
    return (
        <>
        {showCart && <Cart />}
        <nav className='flex sm:justify-between justify-around h-auto pb-2 sm:pr-0 pr-[80px] w-full relative' >
            <div className='flex gap-2 mx-6 flex-center flex-row items-center'>
            ...
            <div className='w-[35%] min-w-[285px] ml-[90px] md:ml-[70px]'>
            ...
            <div className='w-[30%] mr-0 lg:mr-[79px]'>
                ...
                <div className='flex gap-1 md:gap-2 mt-3 sm:mr-2 mr-8 lg:hidden justify-end '>
                    ...
                    <div className='mt-3 sm:mr-2 mr-8 flex flex-row gap-2'>
