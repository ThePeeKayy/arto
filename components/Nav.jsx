...
const Nav = () => {
    ...
    return (
        <>
        {showCart && <Cart />}
        <nav className='flex sm:justify-between justify-around h-auto pb-2 sm:pr-0 pr-[40px] w-full relative' >
            <div className='flex gap-2 ml-6 mr-10 flex-center flex-row items-center'>
            ...
            <div className='w-[30%] mr-0 lg:mr-[79px]'>
                ...
                <div className='flex gap-1 md:gap-2 mt-3 sm:mr-2 mr-12 lg:hidden justify-end '>
                    ...
                    <div className='mt-3 sm:mr-2 mr-12 flex flex-row gap-2'>
